...
func TestGzipFunctionsErrorHandling(t *testing.T) {
	t.Run("IsGzipFile_nonexistent_file", func(t *testing.T) {
	...
	t.Run("IsGzipFile_directory_path", func(t *testing.T) {
		dirPath := t.TempDir()
	...
	t.Run("IsGzipFile_empty_file", func(t *testing.T) {
		tempDir := t.TempDir()
	...
	t.Run("OpenGzipAwareReader_nonexistent_file", func(t *testing.T) {
		nonexistentPath := filepath.Join(t.TempDir(), "nonexistent.log")
	...
	t.Run("CreateGzipAwareScanner_nonexistent_file", func(t *testing.T) {
		nonexistentPath := filepath.Join(t.TempDir(), "nonexistent.log")
	...
	t.Run("CreateGzipAwareScannerWithBuffer_invalid_buffer_size", func(t *testing.T) {
		tempDir := t.TempDir()
